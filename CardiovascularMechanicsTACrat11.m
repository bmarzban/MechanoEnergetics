...
adjvar = [1.357 0.95 1.56 2.0812*1.04 1.3692*0.93 1.3692*0.93 1.231 0.6]; % Rat 20 1.31 kstiff1  % eta = 0.1(19 is mean TAC rat)
tune_ATPase_LV = 1.2167* (1/ 0.6801) *1.0e-3;
