...
% adjvar = [1.15 0.7505 1.2152 2.0812*0.26 1.3692*3 1.3692*3 4.90 1.7]; % Rat 18  % eta = 0.1(19 is mean TAC rat)
adjvar = [1.3 1.15 1.4 2.0812*0.165 1.3692*2.9 1.3692*2.9 0.95 0.56]; % Rat 15  % eta = 0.1(19 is mean TAC rat)

R_TAC = adjvar(8)*R_TAC;

tune_ATPase_LV = 1.5* (1/ 0.6801) *1.0e-3;
