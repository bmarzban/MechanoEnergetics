...
%% para set 4
% adjvar = [1.24 1.04 0.96 1.22 1.3692*0.62 1.3692*0.62 1.0 0.55]; % Rat 12 Swap Metabolite 1.31 kstiff1 % eta = 0.1(19 is mean TAC rat)
adjvar = [1.3098    0.8585    0.9750 1.25 1.3692*0.64 1.3692*0.64 1.0 0.55]; % Rat 12 Swap Metabolite 1.31 kstiff1 % eta = 0.1(19 is mean TAC rat)
