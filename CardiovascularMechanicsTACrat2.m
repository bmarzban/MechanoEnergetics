...
adjvar = [1.2855 0.9205 1.5152 2.0812*1.03 1.3692*0.73 1.3692*0.73 1.320 0.49]; % Rat 11 1.31 kstiff1  % eta = 0.1(19 is mean TAC rat)

R_TAC = adjvar(8)*R_TAC;

tune_ATPase_LV = 0.984* (1/ 0.6801) *1.0e-3;
