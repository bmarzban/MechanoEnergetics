...
% k1      = 152.0917; % transition A1 to A2 rate constant, 1/sec
% km1     = 33.5885; % transition A2 to A1 rate constant, 1/sec
% k2      = 648.1694; % transition A2 to A3 rate constant, 1/sec
% km2     = 33.7370;% transition A3 to A2 rate constant, 1/sec
% k3      = 119.8460; % transition A3 to P rate constant, 1/sec
% 
...
PConcollagen = 0.01; % contriubtion of collagen (??)
...
%  vel = (sigmaf_SEP - sigmapas_SEP - sigmaact_SEP)/eta;
% dSL_SEP = vmax*tanh(2*vel/vmax);% 
...
% N_on_SEP = 1 - N_SEP;  % N_on = P0 + P1_0 + P2_0 + P3_0 (all calcium-bound states)
% N_bound_SEP = 1 - N_SEP - P0_SEP;
U_SR_SEP = 1 - U_NR_SEP;
