...
% Default settings (used in debugging; comment out in MS model)
% TAN = 8.62e-3; % (M per liter cell)
% CRtot = 29.8e-3; % (M per liter cell)
% TEP = 36.0e-3; % (M per liter cell)
% Ox_capacity = 1; % oxidative capacity relative to control sham
% x_ATPase = 1e-3; % ATP hydrolysis rate: M / s / (liter cytosol)
...
% CATIONS
x0(20) = 1.2e-3; % Mg, matrix
x0(21) = 10^-(7.4); % H, matrix
