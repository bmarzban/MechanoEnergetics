...
%% para set 4
adjvar = [1.357 0.95 1.56 1.37 0.8694 0.8694 1. 0.6]; % Rat 20 1.31 kstiff1  % eta = 0.1(19 is mean TAC rat)

% adjvar = [1.29 0.94 1.24 1.395 0.91 0.91 1 0.6]; % Rat 18 %1.31 kstiff  % eta = 0.1(19 is mean TAC rat)

R_TAC = adjvar(8)*R_TAC;

tune_ATPase_LV = 1.532 * (1/ 0.6801) *1.0e-3;
