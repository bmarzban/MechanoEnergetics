...
%% para set 4
adjvar = [1.05 1.01 0.96 1.054 1.3692*0.8 1.3692*0.8 1. 0.55];% Rat 13 Swap Metabolite  1.31 kstiff1 % eta = 0.1(19 is mean TAC rat)

R_TAC = adjvar(8)*R_TAC;

tune_ATPase_LV = 1.6650* (1/ 0.6801) *1.0e-3;
