...
%% para set 4
adjvar = [1.412 0.93 1.39 1.42 1.3692*0.523 1.3692*0.523 1.0 0.5]; % Rat 14  Swap metabolite 1.31 kstiff % eta = 0.1(19 is mean TAC rat)

R_TAC = adjvar(8)*R_TAC;

tune_ATPase_LV = 1.2378* (1/ 0.6801) *1.0e-3;
