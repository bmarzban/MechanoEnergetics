...
% adjvar = [1.296 0.92 2.03 0.91 1.08 1.08 1]; % Rat 10 Swap Metabolite  % eta = 0.1(19 is mean TAC rat)
adjvar = [1.277 0.91 2 1.52 1.03*1.3 1.03*1.3 1]; % Rat 11  % eta = 0.1(19 is mean TAC rat)


tune_ATPase_LV =  1.589 * (1/ 0.6801) *1.0e-3; 
